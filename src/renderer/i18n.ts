...
const en: TextMap = {
  ...
  vgostPresetDescription: "Recommended for video game soundtracks. Uses a longer match window and minimum loop to find natural loop candidates in longer BGM tracks.",
...
const ja: TextMap = {
  ...
  vgostPresetDescription: "ゲームOST向けの標準推奨です。長めの照合区間と最短ループを使い、長いBGMの自然なループ候補をまず安定して探します。",
